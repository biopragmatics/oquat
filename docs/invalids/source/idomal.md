...
|-----------------------|----------------|---------------------------------------------------------|
| `BFO:('BFO', 'SNAP')` |              1 | [IDOMAL:0000002](https://bioregistry.io/IDOMAL:0000002) |
...
| external_xref                     |   usages_count | usages                                                  |
|-----------------------------------|----------------|---------------------------------------------------------|
| `ISBN:('ISBN', '0-8493-15-67-0')` |              1 | [IDOMAL:0000783](https://bioregistry.io/IDOMAL:0000783) |
| `ISBN:('ISBN', '0-412-40180-0:')` |              1 | [IDOMAL:0002188](https://bioregistry.io/IDOMAL:0002188) |
...
| external_xref              |   usages_count | usages                                                    |
|----------------------------|----------------|-----------------------------------------------------------|
| `NCI:('NCI', 'Thesaurus')` |              1 | [IDOMAL:50000048](https://bioregistry.io/IDOMAL:50000048) |
...
| external_xref                             |   usages_count | usages                                                  |
|-------------------------------------------|----------------|---------------------------------------------------------|
| `Wikipedia:('Wikipedia', "Field'sstain")` |              1 | [IDOMAL:0000553](https://bioregistry.io/IDOMAL:0000553) |
