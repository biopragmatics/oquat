# [`icd9`](https://bioregistry.io/icd9): International Classification of Diseases, 9th Revision

This page summarize the different resources that reference `icd9`
but use local unique identifiers that do not match the standard pattern of
`^(\d\d\d|V\d\d|E[8-9]\d\d)(\.\d{1,2})?$`. Of the 5 resources,
1 variants on the standard prefix were found: ['ICD9'].
